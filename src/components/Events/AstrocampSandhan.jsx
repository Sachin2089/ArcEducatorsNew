...
const Intro = () => {
  return (
    ...
    <section className= " w-full text-white py-16 z-10">
      <h1 className="lg:text-[50px]  lg:mb-4 mb-2 mt-2 md:mt-0  text-center text-white pt-3 top-5 text-2xl Grotesk-Black">Astrocamp Sandhan Valley</h1>
      ...
      <div className='flex  xl:flex-row  flex-col overflow-x-hidden gap-8 mt-10'>
        ...
        <div className='xl:w-[45%]  w-[96%] flex flex-col  mt-8 text-neutral-400 font-bold ml-5  lg:visible '>
          ...
          <span className='ml-8 Grotesk-Black'>ARC Educators</span> presents Astrocamp @sandhan valley.
             Travel + stargazing + trekking + camping + Milky way all in one event.
              "We challenge you on this you can count the stars in cities but not in the dark sky"
              Astrocamp is magical experience for those who love camping under sky full of stars along with observations of planets, clusters, nebula and galaxies through Astronomical telescopes and camping.`
          </p>
            ...
            <Link to = "/registartionSandhan"  target =  "_blank" className= "Grotesk-Black hover:bg-opacity-100 bg-opacity-30 bg-[#1779f4] hover:border border-white mx-auto  text-white  py-3 px-6 rounded-md shadow-lg lg:mt-10 md:mt-4 text-[25px]">
              <button >
                Register
              </button>
            </Link>
...
const Batchdetails = () =>{
  return(
    <div className=' w-[100%]  flex flex-col  mt-8 text-black font-bold ml-4  sm:hidden visible'>
      ...
      <Link to = "/registartionSandhan"  target =  "_blank" className= "Grotesk-Black hover:bg-opacity-100 bg-opacity-30 bg-[#1779f4] hover:border border-white mx-auto  text-white  py-2 px-6  justify-center  rounded-md shadow-lg lg:mt-10 md:mt-4 text-[25px]">
              <button >
                Register
                </button>
        </Link>
     ...
     <h2 className='font-bold  md:text-[35px] text-4xl '> Event Details</h2>
      <div>
        ...
        <div className='leading-4'>
          ...
          <li className='list-disc leading-6 py-2'>Place : Sandhan Valley near Bhandardara</li>
          <li className='list-disc leading-6 py-2'>Camping with tent stay.</li>
          <li className='list-disc leading-6 py-2'>Stargazing and Telescopic observations of Moon, Jupiter, Venus and many more celestial objects</li>
          <li className='list-disc leading-6 py-2'>Milky way Photography, Campfire and Activities Session</li>
          <li className='list-disc leading-6 py-2'>Sandhan Valley- Half descend trek (Optional)</li>
          <li className='list-disc leading-6 py-2'>Sanitized stay with Social distancing regulations</li>
          <li className='list-disc leading-6 py-2'>Homely Jain/Veg/Non Veg Food, Breakfast and Snacks</li>
      ...
      <div>
        <div className='border border-gray-400  mt-5 bg-[#ADD8E6] '>
          <h2 className='font-bold text-[20px] my-2 mx-2 rounded-md text-black'> Itinerary (EX Dadar)</h2>
        </div>
        <div className='leading-4'>
         
            <li className='list-disc leading-6 py-2'>11:00 AM - Meeting at Dadar near Pritam Dhaba</li>
            <li className='list-disc leading-6 py-2'>5:30 PM - Arrival at Sandhan Valley base village</li>
            <li className='list-disc leading-6 py-2'>6:00 PM - Evening Snacks and Relaxing time.</li>
            <li className='list-disc leading-6 py-2'>7:00 PM - Introduction to Stargazing</li>
            <li className='list-disc leading-6 py-2'>7:30 PM - Evening Sky session</li>
            <li className='list-disc leading-6 py-2'>9:30 PM - Telescopic Observation</li>
            <li className='list-disc leading-6 py-2'>10:00 PM - Dinner Break</li>
            <li className='list-disc leading-6 py-2'>11:00 PM - Games and Activities</li>
            <li className='list-disc leading-6 py-2'>12:00 AM - Midnight Sky session</li>
            <li className='list-disc leading-6 py-2'>01:00 AM - Telescopic Observation</li>
            <li className='list-disc leading-6 py-2'>02:00 AM - Milkyway Photography</li>
            ...
            <li className='list-disc leading-6 py-2'>07:00 AM - Departure for Sandhan valley half descend trek</li>
            <li className='list-disc leading-6 py-2'>12:00 PM - Lunch at base village</li>
            <li className='list-disc leading-6 py-2'>01:00 PM - Departure from Sandhan Valley base village</li>
            <li className='list-disc leading-6 py-2'>06:00 PM - Arrival at Dadar</li>
        </div>
      </div>
    ...
    <div  >
      ...
      <section className='sm:w-9/12 w-11/12 mx-auto py-8 Grotesk-Normal'>
        ...
        <div className='leading-4'>
          ...
          <li className='list-disc leading-6 py-2'>Includes 3 teas, breakfast, snacks, dinner, and lunch</li>
          ...
          <li className='list-disc leading-6 py-2'>Stargazing expertise charges</li>
          <li className='list-disc leading-6 py-2'>Sandhan Valley trek charges</li>
...
const TicketCosting = () => {
  return (
    ...
    <div className=' sm:w-9/12 w-11/12 mx-auto py-2 text-justify Grotesk-Normal' >
      <h2 className='md:text-[20px] font-bold text-[20px] bg-[#ADD8E6] text-black p-2  rounded-md'>Costing Per Person</h2>
      
      <table className="w-full table-auto border-collapse   mt-10">
      
        <tbody className=''>
          <tr>
            <td className="border border-white px-4 py-2  text-center w-1/2 text-[21px] ">Including Ac bus traveling from Dadar</td>
            <td className="border border-white px-4 py-3  text-center  text-[20px]"> ₹ 2,500</td>
          </tr>
          <tr>
            <td className="border  border-white px-4 py-3  text-center w-1/2 text-[20px]"> Kids including AC bus Traveling (between 5 to 10 years)</td>
            <td className="border border-white px-4 py-3 text-center  text-[20px]">₹ 2,000</td>
            
          </tr>
          <tr>
            <td className="border border-white px-4 py-3 text-center text-[20px] w-1/2"> By Own Vehicle</td>
            <td className="border border-white px-4 py-3 text-center  text-[20px]">₹ 1,800</td>
            
          </tr>
          <tr>
            <td className="border border-white px-4 py-3 text-center text-[20px] w-1/2"> kids (between 5 to 10 years) by Own Vehicle :</td>
            <td className="border border-white px-4 py-3 text-center  text-[20px]">₹ 1,300</td>

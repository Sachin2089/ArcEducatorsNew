...
const LINKS = [
  ...
  {
    title: "Gallery",
    items: ["Dahanu", "Sandhan", "", "Data Interpretation"],
  },
  {
    title: "Services",
    items: ["Arc Planeterium", "", "Reasoning", "Data Interpretation"],
  },
];
            ...
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="mb-3 text-base mr-4 Apercu-Regular opacity-50"
                >
                  {title}
                </Typography>
                {items.map((link) => (
                  <li key={link}>
                    <Typography
                      ...
                      href="#"
                      color="gray"
                      className="py-1.5 Apercu-Light transition-colors hover:text-blue-gray-900"
                    >
                      {link}
                    </Typography>
                  </li>
